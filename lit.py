...
░░░░░░░░____▓░
\033[1;32m╔════════════════════════════════════════════════╗
\033[1;32m║Supported         : X TEAM                      ║
\033[1;32m║Special Thanks    : ALL MEMBER X TEAM           ║
\033[1;32m║Video channel     : Hike Me                     ║
\033[1;32m║Telegram group    : @srilankanhackersscript     ║
\033[1;32m║Doge Donate :D5oEuDt89Lk5H48o7AQAmiGXh1fdy6RuPS ║
\033[1;32m╚════════════════════════════════════════════════╝
"""+Style.RESET_ALL+Style.BRIGHT+Fore.WHITE+"""[Subscribe YT - Hike Me]  [Author :  Nimesh D kavindu - Hike Me]
"""

cname = '@Free_LTC_Robot'
crot = 'https://t.me/Free_LTC_Robot'
...
async def main():
	...
	# Free_LTC_Robot
	print_msg_time(Fore.GREEN + f'Name    : @Free_LTC_Robot '  + Fore.RESET)
	...
	while(True):
		...
		print_msg_time(Fore.GREEN + ' 🎁Bonus Collect +0.00001 Litecoin (LTC) New Bonus Coming In 30 Minutes ' + choice + Fore.RESET)
		time.sleep(1800)
		i = 1
